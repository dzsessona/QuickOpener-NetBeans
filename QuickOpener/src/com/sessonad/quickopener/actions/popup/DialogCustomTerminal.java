...
public class DialogCustomTerminal extends javax.swing.JDialog {
     ...
     */
    public DialogCustomTerminal(java.awt.Frame parent, boolean modal,List<QuickOpenerProperty> qoPrefs) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                DialogCustomTerminal dialog = new DialogCustomTerminal(new javax.swing.JFrame(), true,null);
